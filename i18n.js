(() => {
  ...
  const es = {
    ...
    "Empty MPG": "MPG vacío",
    "Diesel price override": "Precio manual del diésel",
    "Use live price": "Usar precio en vivo",
    "Toll program": "Programa de peajes",
    "No discount selected": "Sin descuento seleccionado",
    "Hours of Service": "Horas de servicio",
    "Driving remaining": "Conducción restante",
    "Shift remaining": "Turno restante",
    "Cycle remaining": "Ciclo restante",
    "HOS rule": "Regla HOS",
    "US property — 70/8": "Carga EE. UU. — 70/8",
    "US property — 60/7": "Carga EE. UU. — 60/7",
    "Canada Cycle 1": "Canadá Ciclo 1",
    "Simple mode uses total miles × operating cost per mile, then adds tolls.":
      "El modo simple usa millas totales × costo operativo por milla y luego suma peajes.",
    "Detailed mode calculates fuel, other mileage costs and tolls separately.":
      "El modo detallado calcula por separado combustible, otros costos por milla y peajes.",
    "Manual override": "Precio manual",
    "Published/manual": "Publicado/manual",
    "Manual clocks": "Relojes manuales",
    "Samsara live clocks": "Relojes en vivo de Samsara",
    "Supabase loads": "Cargas de Supabase",
    "active load": "carga activa",
    "active loads": "cargas activas",
    "Trimble route estimates": "rutas estimadas por Trimble",
    "Other mileage cost": "Otros costos por millas",
